...
/**
 * @author: Jeremy Chen A GameSystem that provides generic behavior for entites that posses a
...
public class CollisionResponseSystem extends GameSystem {
	...
	public void act(double elapsedTime, Level level) {
		List<Entity> collidedEntities = level.getEntitiesContainingAny(TARGET_COMPONENTS);
